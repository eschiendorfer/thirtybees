...
class ConfigurationCore extends ObjectModel
{
    ...
    const CUSTOMER_SERVICE_EMAIL = 'PS_CUSTOMER_SERVICE_EMAIL';
    const CUSTOMER_SERVICE_SENDER_NAME = 'PS_CUSTOMER_SERVICE_SENDER_NAME';
    const CUSTOMER_SERVICE_SIGNATURE = 'PS_CUSTOMER_SERVICE_SIGNATURE';
    const CUSTOMER_SERVICE_MAX_ATTACHMENTS = 'PS_CUSTOMER_SERVICE_MAX_ATTACHMENTS';
    const CUSTOMER_SERVICE_MAX_ATTACHMENTS_TOTAL_SIZE = 'PS_CUSTOMER_SERVICE_MAX_ATTACHMENTS_TOTAL_SIZE';
    const CUSTOMER_SERVICE_MAX_EMAIL_ATTACHMENTS_TOTAL_SIZE = 'PS_CUSTOMER_SERVICE_MAX_EMAIL_ATTACHMENTS_TOTAL_SIZE';
    ...
    const STOCK_CUSTOMER_RETURN_REASON = 'PS_STOCK_CUSTOMER_RETURN_REASON';
