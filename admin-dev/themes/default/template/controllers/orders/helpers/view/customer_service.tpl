        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <select id="status_msg" name="status_msg">
              ...
              <option value="pending1" {if isset($customer_thread_message[0]['status']) && ($customer_thread_message[0]['status']=='pending1' || $customer_thread_message[0]['status']=='pending2')}selected{/if}>{l s='In progress'}</option>
              <option value="waiting_customer" {if isset($customer_thread_message[0]['status']) && $customer_thread_message[0]['status']=='waiting_customer'}selected{/if}>{l s='Waiting for customer reply'}</option>
